  ...
  return (
    <main className="page-shell">
      <header className="page-header">
        ...
        <div>
          <h1>
            {PROJECT_INFO.nameZh} ({PROJECT_INFO.name})
          </h1>
      ...
      <section className="about-grid">
        <article className="about-card">
          ...
          <h2>版本与许可证</h2>
          <p>
            当前版本 v{PROJECT_INFO.version}，采用 {PROJECT_INFO.license}{' '}
            许可证。自定义词库、云端词库、屏蔽历史与待拉黑队列均保存在本地。
          </p>
        ...
        <article className="about-card">
          ...
          <p>
            欢迎在 GitHub 提交
            bug、功能建议、规则改进和真实使用反馈。觉得项目有帮助，也可以赞助维护。
          </p>
